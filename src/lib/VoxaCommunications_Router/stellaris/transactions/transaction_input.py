...
from VoxaCommunications_Router.stellaris.constants import CURVE, ENDIAN, SMALLEST
from VoxaCommunications_Router.stellaris.utils.general import point_to_string, string_to_point
...
class TransactionInput:
    ...
    async def get_transaction(self):
        if self.transaction is None:
            from VoxaCommunications_Router.stellaris.database import Database
